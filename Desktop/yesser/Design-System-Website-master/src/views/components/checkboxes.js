       ...
       <div className='bg-white border-radius p-4'>
            <div className='row border-bottom mb-4'>
                <div className="col-md-3">
                    <h3 className='mt-0 mt-md-3 text-darkBlue pb-0 pb-md-3'>{t("checkbox")}</h3>
                </div>
            ...
            <p className="mt-4">{t("checkbox-p1")}</p>

            <p className="mt-4 mb-1 font-weight-bold">{t("checkbox-p2")}</p>
            <ul>
                <li>{t("checkbox-li-1")}</li>
                <li>{t("checkbox-li-2")}</li>
                <li>{t("checkbox-li-3")}</li>
                <li>{t("checkbox-li-4")}</li>
                <li>{t("checkbox-li-5")}</li>
            </ul>

            <p className="mt-4 mb-1 font-weight-bold">{t("checkbox-differentElements")}</p>
            <ul>
                <li>{t("checkbox-differentElements1")}</li>
                <li>{t("checkbox-differentElements2")}</li>
                <li>{t("checkbox-differentElements3")}</li>
            </ul>

            <p className="mt-4">{t("checkbox-desc")}</p>

            <h5 className="mt-4 text-darkBlue">{t("checkbox-example-title")}</h5>
            <p className="mb-1">{t("checkbox-example")}</p>
  
            <h5 className="mt-4 text-darkBlue">{t("checkbox-Arabic-title")}</h5>
            <p className="mb-1">{t("checkbox-Arabic")}</p>
            <Checkbox></Checkbox>
            <div className="col-md-2">
                <label className="govsa-checkbox">{t("disabled-label")}
                                            ...
                                            <pre id="cod-text"> 
                                                <code>
                                                    <span >
                                                        ...
                                                        =
                                                        <span class="text-danger "> "govsa-checkbox" </span>
                                                        &gt;
                                                    </span>
                                                    ...
                                                    <span>
                                                        ...
                                                        =
                                                        <span class="text-danger ">"checkbox" </span>
                                                        / &gt;
                                                    </span>
                                                    <samp className="d-block"></samp>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <span >
                                                        ...
                                                        <span class="text-green"> class </span>
                                                        =
                                                        <span class="text-danger "> "govsa-checkbox__checkmark" </span>
                                                        &gt;
                                                    </span>
                                                    <span>
                                                        &lt;/
                ...
                <div className="card">
                    ...
                    <div id="collapseOne2" className="collapse" aria-labelledby="headingOne2" data-parent="#accordionExample2">
                        <div className="card-body pb-3">
                            ...
                            <p className="">{t("checkbox-p3")}</p>
                            <h6>{t("implemntation")}</h6>
                            <p className="mb-0">{t("package-usage")}: import 'govsa-ds/packages/govsa-checkbox' </p>
                        </div>
                    </div>
                </div>
            </div>
...
export default withNamespaces()(CheckboxHome);